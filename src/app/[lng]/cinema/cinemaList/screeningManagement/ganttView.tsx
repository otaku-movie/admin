...
// 页面已按「营业日（30h）」重组数据：当天 <6:00 的早场归前一天、被剔除，次日 <6:00 的
// 早场作为午夜尾巴并入（其 start_time 是次日 00:xx，按与本日零点的时间差自然落在 24-30）。
// 时间窗口固定为营业日 06:00 ~ 30:00：无论该影院当天有没有午夜场，横轴都一致到 30:00，
// 避免「有的影院停在 24、有的到 28/30」的不统一观感。若极少数场次结束超过 30:00 再自动外扩。
